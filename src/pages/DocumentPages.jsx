...
export function InvoicesPage({vendors,invoices,vendorFilter,setVendorFilter,vendorColors,formatDate,formatMoney,
  ...
  return <div>
    <PageHeader eyebrow="Purchasing records" title="Invoice History" description="Invoices are preserved as their original files for historical reference. KERDOS reads them in the background only to verify that ordered items and charged prices agree with the applicable price sheet." actionLabel="🧾 Import Invoice" onAction={()=>onImport(vendorFilter)} secondaryLabel="Export Variance Report" onSecondary={onExport}/>
